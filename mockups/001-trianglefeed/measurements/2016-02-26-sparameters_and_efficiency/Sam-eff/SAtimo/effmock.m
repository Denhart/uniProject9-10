...
csvwrite('Triag-LB-Side-V.csv', [f' effdB'])
...
eff=Hpol_sphere_int*2*pi/15*pi/8; % 15 probes and 8 positions: this is to integrate over the sphere
effdB=10*log10(eff);
end