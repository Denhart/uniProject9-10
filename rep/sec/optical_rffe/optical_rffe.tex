...
The microcontroller is an Atmel ATmega168. It receives one-byte commands from the PC through UART at \SI{9600}{baud}. The commands are ASCII characters as described in Table~\ref{tab:rffe_commands}.
...
\fixme{Figure: Example of a RFFE write reg command. }
