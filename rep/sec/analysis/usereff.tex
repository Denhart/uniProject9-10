...
\begin{aautop}
    In this section, the user's impact on mobile antenna performance will be described, including both effects of the head, the hand, and the body in general.
\end{aautop}
...
\subsection{SAR -- Specific Absorption Rate}
