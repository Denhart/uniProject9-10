...
\begin{table}
    ...
    \begin{tabular}{|l|c|c|}
        ...
        \hline
        $\omega_L$  & \multicolumn{2}{c|}{$2\pi f_{\text{low}}$} \\
        $\omega_H$  & \multicolumn{2}{c|}{$2\pi f_{\text{high}}$} \\
        \hline
        $X_1(\omega)$ & $Z_0 \imag{\dfrac{2S_{21}}{1 + S_{11} + S_{22} + S_{11}S_{22} - S_{21}^2}}$ & \\
        $X_2(\omega)$ & $Z_0 \imag{\dfrac{1 + S_{11} + S_{22} + (S_{11}S_{22}-S_{21}^2)}{1 + S_{11} - S_{22} - 2S_{21} - (S_{11}S_{22} - S_{21}^2)}}$ & \\
        \hline
        $R_1$ &  & \\
        $L_1$ & & \\
        $C_1$ & & \\
        ...
        \hline
    \end{tabular}
    \caption{Formulas for computing the equivalent circuit components from S-parameters measured at two frequencies \cite{gu2014rf}. \fixme{Finish this}}
