...
Where, $W_e$ is the time-average non-propagating stored electric energy, $W_m$ is the same a the above just with magnetic energy. $\omega$ is the radian frequency and $P_{\text{rad}}$ denotes the radiated power.
