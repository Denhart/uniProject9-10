...
\begin{aautop}
    The requirement specification sums up requirements, definitions, and guidelines for designing the antennas in the following chapters. Not all the requirement are hard requirements but guidelines for the design process.
\end{aautop}
...
\begin{aautail}
In this chapter, the functional and specific requirements for the antennas have been listed. The next chapter contains a test specification for the above specific requirements, describing how each requirement will be tested. 
\end{aautail}
