...
As seen, the equations quickly become large and hard to handle. However, to fully extend this to 3D, this would have to be done for all the Cartesian coordinates for both E- and H-fields. 
