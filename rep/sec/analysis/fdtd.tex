...
Generally the magic time-step is only an exact solution in 1D, but it exists for all dimensions but only for one incident angle. It is also seen that finer mesh cells reduces the error term.  
