...
%Efficiency
The efficiency in data mode for both antennas, can be seen in Figure \ref{fig:corr_sols_data}. The efficiency is plotted for each sweep of the tunable capacitors.
