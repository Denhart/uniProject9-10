...
The isolation loss results shows the highest isolation loss in the low band, at approximately \SI{800}{MHz} to \SI{900}{MHz} for both the top and side antenna. This results is as expected when compared with the simulation results.
    \begin{figure}[htbp]
   \begin{subfigure}[b]{0.49\linewidth}
        \centering
