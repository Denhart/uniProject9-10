...
The S-parameters of the prototype can be seen on Figure \ref{fig:sparam_mono_proto_sim}. 
...
\begin{figure}[htbp]
   \begin{subfigure}[b]{0.49\linewidth}
        \centering
        \includegraphics[scale=0.1]{img/tech_sol/monopole/prototype_v1/monopole_v1}
