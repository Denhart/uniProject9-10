...
\fixme{Write about isolation loss.}
...
\fixme{bandwidth table and documentation for all positions.}
\FloatBarrier
...
%S-Parameters
The S-parameter sweeps can be seen in Figure \ref{fig:sparam_mono_modi_play_mode}. The maximum bandwidth can be seen in Table \ref{tab:bw_mono_modi_pm}. Compared to the data mode, the play mode have a slightly higher bandwidth in general but is more de-tuned.   
\begin{table}[htbp]
  \centering
  \begin{tabular}{|l|l|r|r|r|}
    \hline
...
%Efficiency
The efficiency sweep can be seen in Figure \ref{fig:eff_mono_modi_play_mode}. \fixme{New graphs\ldots}
\begin{figure}[htbp]
    \centering
    \begin{subfigure}{0.49\linewidth}
    ...
    \begin{subfigure}{0.49\linewidth}
        ...
        \caption{Sweeping $C_2$ and fixing $C_1$.}
    \end{subfigure}
    \caption{Monopole antenna in play mode. Efficiency for each antenna when sweeping the tunable capacitors. Here, $C_1$ and $C_2$ are the tuning capacitor for the top and side antenna, respectively. \fixme{Problem with sweeps?}}
...
%Efficiency
The efficiency sweep can be seen in Figure \ref{fig:eff_mono_modi_talk_mode}. \fixme{Update graphs\ldots}
\begin{figure}[htbp]
    \centering
    \begin{subfigure}{0.49\linewidth}
    ...
    \begin{subfigure}{0.49\linewidth}
        ...
        \caption{Sweeping $C_2$ and fixing $C_1$.}
    \end{subfigure}
    \caption{Monopole antenna in talk mode. Efficiency for each antenna when sweeping the tunable capacitors. Here, $C_1$ and $C_2$ are the tuning capacitor for the top and side antenna, respectively. \fixme{Problem with sweeps.}}
