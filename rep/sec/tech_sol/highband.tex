...
%Efficiency
The efficiency sweep can be seen in Figure \ref{fig:eff_mono_modi_talk_mode}. For the low band, the efficiency has dropped to less than \SI{-10}{dB} for both antennas. In the high band, the top antenna generally has an efficiency above \SI{-10}{dB} except for a notch at around \SI{1900}{MHz} to \SI{2000}{MHz}. The side antenna has an efficiency above \SI{-12}{dB} in the high band.
\begin{figure}[htbp]
    \centering
    \begin{subfigure}{0.49\linewidth}
