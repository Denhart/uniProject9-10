...
From the $S$-parameter measurements of both the triangle-feed antenna and the minimized monopole antenna, it is clear that both antennas are experiencing problems in the high band when going from the simulation to the tuner PCB.
