% vim: nospell
\documentclass[oneside,17pt]{report}
\usepackage{extsizes}
...
\tikzexternalize[prefix=img/tikztmp/]
\tikzset{
    >=latex,
    font=\footnotesize
}
...
%   Page Setup
\usepackage[top=10mm, bottom=10mm, left=10mm, right=10mm, a4paper]{geometry}
...
\renewcommand{\tabularx}{\tiny\oldtabularx}
