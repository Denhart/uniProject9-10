...
# Plots a parameter sweep, Efficiency file from CST.
...
sub printhelp {
    print "Usage:\n";
    print "    perl ploteffsweep.pl SWEEPFILE.txt OUTFILE.pdf\n";
...
my $cmd = "python $here/plotefficiency.py " . join(" ", @outfiles) . " -n -o $o";
