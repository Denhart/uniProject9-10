...
# Plots a parameter sweep, Correlation file from CST.
...
sub printhelp {
    print "Usage:\n";
    print "    perl plotcorrsweep.pl SWEEPFILE.txt OUTFILE.pdf\n";
...
my $cmd = "python $here/plotcorrelation.py " . join(" ", @outfiles) . " -n -o $o";
