...
%     \emptyline
%     \begin{center}
%         \includegraphics{img/soren/ue/design1lt/s21top.pdf}\\
%         \includegraphics{img/soren/ue/design2sn/s21top.pdf}\\
%         \includegraphics{img/soren/ue/design3hv/s21top.pdf}
%     \end{center}
%     \legendfooter
% \end{frame}
% 
...
%     \emptyline
%     \begin{center}
%         \includegraphics{img/soren/ue/design1lt/s21side.pdf}\\
%         \includegraphics{img/soren/ue/design2sn/s21side.pdf}\\
%         \includegraphics{img/soren/ue/design3hv/s21side.pdf}
%     \end{center}
%     \legendfooter
% \end{frame}
