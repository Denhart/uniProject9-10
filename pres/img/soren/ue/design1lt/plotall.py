...
# S21 top
S = [ g("1-fs/s21top/S2*"), g("2-data/s21top/S2*"), g("3-play/s21top/S2*"), g("4-talk/s21top/S2*") ]
plotextreme(S, "min", "sparam")
savecrop("s21top.pdf")
...
# Correlation
C = [ g("1-fs/corrtop/run_*"), g("2-data/corrtop/run_*"), g("3-play/corrtop/run_*"), g("4-talk/corrtop/run_*") ]
plotextreme(C, "min", "correlation")
savecrop("corrtop.pdf")

C = [ g("1-fs/corrside/run_*"), g("2-data/corrside/c4*"), g("3-play/corrside/run_*"), g("4-talk/corrside/c4*") ]
plotextreme(C, "min", "correlation")
